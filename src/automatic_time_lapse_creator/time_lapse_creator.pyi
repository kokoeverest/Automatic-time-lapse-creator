...
from datetime import _IsoCalendarDate # type: ignore
...
class CustomTimeSpan(NamedTuple):
    start_hour: int
    start_minutes: int
    end_hour: int
    end_minutes: int
class TimeLapseCreator:
    ...
    def __init__(
        ...
        create_weekly_summary_video: bool = ...,
        day_for_monthly_summary_video: int = ...,
        delete_collected_daily_images: bool = ...,
        delete_daily_videos_after_summary_is_created: bool = ...,
        sunrise_offset_minutes: int = ...,
        sunset_offset_minutes: int = ...,
    ) -> None: ...
    @staticmethod
    def _validate(attr_name: str, attr_value: int, logger: Logger) -> int: ...
    @property
    def folder_name(self) -> str: ...
    @property
    def weekly_folder_name(self) -> str: ...
    def set_folder_name(self, value: str) -> None: ...
    def set_weekly_folder_name(self, value: str) -> None: ...
    ...
    @staticmethod
    def get_current_calendar(y_w_d_str: str) -> _IsoCalendarDate: ...
    def create_video(
    ...
    def get_video_files_paths(
        base_folder: str, year: str, month: str
    ) -> list[str]: ...
    ...
    def process_daily_videos(self) -> None: ...
    def process_weekly_summary(self) -> None: ...
    def process_monthly_summary(self) -> None: ...
    @staticmethod
    def get_previous_year_and_month(folder_name: str) -> str: ...
