...
MAX_SUNRISE_OFFSET_MINUTES = 301 # five hours
MAX_SUNSET_OFFSET_MINUTES = 121 # two hours
...
ONE_AND_SIXTY = (1, 61)
DEFAULT_WAIT_BETWEEN_FRAMES_NIGHTTIME_MULTIPLIER_VALIDATION_RANGE = (2, 10)
...
DEFAULT_EMAIL_AUTH_TIMEOUT_SECONDS = 3600
